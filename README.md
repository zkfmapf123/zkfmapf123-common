...
| report-outputs | "보고해줘" / `/common:report-outputs` | Designed HTML report of the session's result, published as an Artifact (uses `frontend-design` when installed) |
...
parallel → one line per member + synthesis in chat → `judge/<ts>.md`
